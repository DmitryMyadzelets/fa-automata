...
(function() {
  'use strict';
  var find_common_events, get_event_by_labels, i_look, set_transitions, show_bfs, show_dfs, show_events, show_modules, show_modules_transitions, show_states, show_transitions,
  ...
  this.look = function() {
    if (i_look >= DES.modules.length) {
      i_look = 0;
    }
    if ((i_look >= 0) && (i_look < DES.modules.length)) {
