...
(function() {
  'use strict';
  var friction, getLinkCurve, graph, height, is_linked, link_charge, link_charge_distance, link_distance, link_gravity, makeLink, node_radius, svg_container_id, update_SVG, update_svg_size, vec, width;
