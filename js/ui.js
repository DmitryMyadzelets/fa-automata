...
(function() {
  'use strict';
  var force_stop, friction, getLinkCurve, graph, height, is_linked, ix, link_charge, link_charge_distance, link_distance, link_gravity, makeLink, node_radius, svg_container_id, update_SVG, update_svg_size, vec, width;
  ...
  this.UI = {
    show_module: function(m) {
      var cnt, e, i, link, n, node, p, q, type, _ref;
      ...
      n = m.T.size();
      while (i < n) {
        _ref = m.T.transitions.get(i), q = _ref[0], e = _ref[1], p = _ref[2];
        type = [0];
        type[0] = q === p ? 1 : 0;
