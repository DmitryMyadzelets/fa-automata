...
(function() {
  'use strict';
  var A, B, C, G, NUM_STATES, S, Set, make_G,
  ...
  */
  ...
  Set = (function() {
    var change_length, change_subsets_size, get_bit, get_default, self, set_bit, subsets, unset_bit,
      _this = this;
  ...
  S.modules.X.marked.set(1);

  S.modules.X.marked();

  S.modules.X.marked(1);
