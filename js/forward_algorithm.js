...
(function() {
  'use strict';
  var F, N, cnt, dt, get_event_by_labels, get_last_events, ix, m, make_F_module, make_NF_module, make_N_module, make_projection, ms, s, set_transitions, show_dfs, show_events, show_modules, show_modules_transitions, show_states, show_transitions, start, stop, _i, _len, _ref,
  ...
  (function() {
    ...
    propagate_FN = function(k, F, N) {
      var F_, Fc, Fj_, Fj__, K, NF_, N_, Nc, Nj_, Nj__, cap, common, index, j, _i, _len, _ref;
      ...
      for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
        ...
        if (!DES.is_empty(Fj__) || !DES.is_empty(Nj__)) {
          j.F = DES.sync(j.F, Fj_, DES.get_common_events(j.F, Fj_));
          j.N = DES.sync(j.N, Nj_, DES.get_common_events(j.N, Nj_));
  ...
  for (ix = _i = 0, _len = _ref.length; _i < _len; ix = ++_i) {
    m = _ref[ix];
    if ((!DES.is_empty(m.N)) || (!DES.is_empty(m.F))) {
      if (!DES.is_empty(m.N)) {
        if (N == null) {
          N = m.N;
        } else {
